/**
 *
 * $Header: /cvsroot/lesstif/lesstif/include/Motif-1.2/Xm/Xm.h.in,v 1.23 2003/08/03 11:51:20 dannybackx Exp $
 *
...
#define LesstifVERSION_STRING "@(#)GNU/LessTif Version 1.2 Release 0.93.94"
...
typedef enum {
    ...
    XmFONT_IS_XFT	/* FontConfig - not used in Motif 1.2 */
} XmFontType;
...
/*
 * Rendering stuff is Motif 2.x API.
 *	However the LessTif 1.2 internal XmFontList representation mimicks
 *	the 2.x XmRendition and XmRenderTable.
 *
